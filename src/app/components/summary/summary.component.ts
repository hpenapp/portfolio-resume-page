      ...
      <div class="flex flex-col lg:flex-row gap-12 items-center lg:items-start" *ngIf="personalInfo">
        ...
        <div class="lg:w-7/12" data-aos="fade-right">
          ...
          <div class="flex items-start">
              ...
              <div>
                <p class="text-sm text-textSecondary font-semibold uppercase tracking-wider">Location</p>
            ...
            <div class="flex items-start">
              ...
              <div>
                <p class="text-sm text-textSecondary font-semibold uppercase tracking-wider">Degree</p>
            ...
            <div class="flex items-start">
              ...
              <div>
                <p class="text-sm text-textSecondary font-semibold uppercase tracking-wider">Email</p>
            ...
            <div class="flex items-start">
              ...
              <div>
                <p class="text-sm text-textSecondary font-semibold uppercase tracking-wider">Phone</p>

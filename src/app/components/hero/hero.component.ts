...
@Component({
  ...
  template: `
    <section class="relative min-h-screen flex flex-col justify-center items-center text-center px-4 pt-20 overflow-hidden">
      ...
      <div class="relative z-10" data-aos="fade-up">
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-12" *ngIf="personalInfo">
          <!-- LinkedIn -->
          <a [href]="personalInfo.linkedin" target="_blank" class="social-btn group" title="LinkedIn">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452z"/></svg>
          </a>
          <!-- GitHub -->
          <a [href]="personalInfo.github" target="_blank" class="social-btn group" title="GitHub">
          ...
          <!-- Email -->
          <a [href]="'mailto:' + personalInfo.email" class="social-btn group" title="Email">
  ...
  styles: [`
    .social-btn {
      @apply flex items-center bg-transparent border-2 border-primary text-primary px-6 py-3 transition-all duration-300 hover:bg-primary hover:text-background;
      border-radius: 2px;
    }
  `]
})
